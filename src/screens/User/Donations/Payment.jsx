...
function Payment({ navigation }) {
  ...
  const { preference, notes } = route.params;
  ...
  const onPayment = async () => {
    ...
    if (
      ...
      await axios
        .post(
          "https://life-on-land-backend.azurewebsites.net/api/payment/createPayment",
          data,
          {
            headers: {
              Authorization: token,
        ...
        .then((res) => {
          if (res.data.status) {
            ...
            Alert.alert("Error", "Paiment Faild", [
              {
                text: "Ok",
              },
            ]);
    ...
    <View style={styles.container}>
      <View style={styles.backgroundStack}>
        ...
        <View style={styles.rect2}>
          ...
          <View
            style={[styles.container123, styles.materialUnderlineTextbox34]}
          >
            <TextInput
          ...
          <View style={styles.materialUnderlineTextbox35Row}>
            <View
              style={[styles.container123, styles.materialUnderlineTextbox35]}
            >
              <TextInput
                placeholder="MM/YY"
                placeholderTextColor="rgba(0,0,0,1)"
            ...
            <View
              style={[styles.container123, styles.materialUnderlineTextbox36]}
            >
              <TextInput
                placeholder="CVV"
                placeholderTextColor="rgba(0,0,0,1)"
          ...
          <View
            style={[styles.container123, styles.materialUnderlineTextbox37]}
          >
            <TextInput
          ...
          <TouchableOpacity
            // navigation.navigate("PaymentSuccessful")
            onPress={onPayment}
            style={[styles.containerbtn1, styles.materialButtonViolet20]}
          >
