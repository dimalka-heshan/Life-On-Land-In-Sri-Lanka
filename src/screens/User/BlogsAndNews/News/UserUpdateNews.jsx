...
function UserUpdateNews(props) {
  ...
  const GetNews = async () => {
    ...
    await axios
      ...
      .then((res) => {
        setnewsTittle(res.data.news.newsTittle);
        setnewsContent(res.data.news.newsContent);
        setnewsImage(res.data.news.newsImage);
      });
  };
  ...
  const updateNews = async () => {
    ...
    await axios
      .patch(
        `https://life-on-land-backend.azurewebsites.net/api/news/updateNews/${newsID}`,
        {
    ...
    <View style={styles.container}>
      <View style={styles.backgroundStack}>
        <View style={styles.frame61}>
          <Text style={styles.pitcherPlantInSriLanka}>Update News</Text>
        </View>
