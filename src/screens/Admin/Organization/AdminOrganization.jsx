        ...
        <View style={styles.group13}>
          <View style={styles.backgroundStack}>
            ...
            <EntypoIcon
              ...
              onPress={() => navigation.navigate('AdminAddOrganizationPage')}
              style={styles.icon12}
            ></EntypoIcon>
            ...
            <View style={styles.scrollArea}>
              ...
              >
                <TouchableOpacity onPress={() => navigation.navigate('AdminSpecificOrgPage')}>
                    ...
                    <View style={styles.image1Row}>
                      ...
                      <View style={styles.environmantalColumn}>
                        ...
                        <IoniconsIcon
                          ...
                          style={styles.icon33}
                        ></IoniconsIcon>
                          <Text style={styles.loremIpsum1}>2022 - 11 - 20</Text>
                          <MaterialCommunityIconsIcon
